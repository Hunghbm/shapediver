...
export const createMenu = (session: ISessionApi, viewport: IViewportApi) => {
  ...
  inputNumberOfSpokes.value = +parameterNumberOfSpokes.value + "";
  ...
  inputIngoingForce.value = +parameterIngoingForce.value + "";
  ...
  inputGoInsane.value = +parameterGoInsane.value + "";
  ...
  inputHorizontal.value = +parameterHorizontal.value + "";
  ...
  inputVertical.value = +parameterVertical.value + "";
  ...
  inputMorphing.value = +parameterMorphing.value + "";
  ...
  inputPattern.value = +parameterPattern.value + "";
